        ...
        <div className="border border-bingo-red rounded-2xl p-6 bg-slate-900/20 flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm font-bold uppercase">
              {isEditing
                ? `Updating event: ${initialData?.home_team} vs ${initialData?.away_team}`
        ...
        <div className="border border-bingo-red rounded-3xl p-8 bg-slate-900/10 backdrop-blur-sm">
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <button
              ...
              className="w-full bg-bingo-dark hover:bg-red-800 text-bingo-red border border-bingo-red py-4 rounded-xl font-black uppercase transition-all flex items-center justify-center gap-3 disabled:opacity-50 shadow-lg shadow-red-950/20"
            >
              {isProcessing ? (
                "Processing..."
              ) : isEditing ? (
