      ...
      <div className="max-w-[1600px] mx-auto space-y-6">
        <div className="flex justify-between items-center bg-slate-900/40 border border-bingo-red p-6 rounded-3xl">
          <div className="flex items-center gap-4">
            <Link
              to="/admin/cards"
              className="p-2 hover:bg-slate-800 rounded-xl text-bingo-red"
            >
              <ChevronLeft />
            </Link>
        ...
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-3 space-y-4">
            <div className="bg-slate-900/40 border border-bingo-red p-6 rounded-3xl space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl p-4 mt-2 outline-none focus:border-bingo-red appearance-none font-bold"
                  placeholder="10.00"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl p-4 mt-2 outline-none focus:border-green-500 appearance-none"
                    placeholder="50"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl p-4 mt-2 outline-none focus:border-yellow-500 appearance-none"
                    placeholder="500"
                  />
                </div>
              </div>
            ...
            <div className="p-4 border border-bingo-red rounded-2xl flex gap-3 text-white">
              ...
              <p className="text-[10px] font-semibold uppercase">
                Drag and Drop the events from the library to the Bingo Card.
              </p>
            </div>
          </div>
            ...
            >
              {gridEvents.map((slot, idx) => (
                ...
                >
                  {slot ? (
                    <>
                      <span className="text-[8px] font-black text-bingo-red uppercase">
                        {slot.sport}
                      </span>
          ...
          <div className="col-span-4 bg-slate-900/40 border border-bingo-red rounded-3xl p-6 h-[75vh] flex flex-col">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="bg-slate-800 text-[10px] px-2 py-1 rounded font-bold text-slate-500">
