...
export default function BingoCard({ data, isLogged }) {
    ...
    return (
        <div className="border-2 border-bingo-red rounded-2xl p-8 bg-[#02182B] shadow-[0_0_20px_rgba(220,38,38,0.1)] text-white">
            <h3 className="font-bold text-xl mb-8">Bingo Card</h3>
